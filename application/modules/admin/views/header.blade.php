        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{{base_url()}}du-an">Dự án</a></li>
                    ...
                    <li class="account dropdown">
                        <a id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                            <img src="{{base_url()}}public/img/tran.jpg" style='width:30px;height: 30px;border-radius: 50%;'/>
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li> 
                                <a href="{{base_url()}}admin/logout">Quản lý tài khoản</a>
                            </li>
                            <li>
                                <a href="{{base_url()}}admin/logout">Đăng tin</a>
                            </li>
