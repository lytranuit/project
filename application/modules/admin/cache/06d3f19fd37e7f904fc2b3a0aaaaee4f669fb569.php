                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="account dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li> 
                                <a href="<?php echo e(base_url()); ?>admin/logout">Quản lý tài khoản</a>
                            </li>
                            <li>
                                <a href="<?php echo e(base_url()); ?>admin/logout">Đăng tin</a>
                            </li>
                            <li role="separator" class="divider"></li>
                            <li>
                                <a href="<?php echo e(base_url()); ?>admin/logout">Đăng xuất</a>
                            </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" action="<?php echo e(base_url()); ?>admin/login" method="post">
