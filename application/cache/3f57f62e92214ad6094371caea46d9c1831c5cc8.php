<form name="form" id="form-edit-user" action="<?php echo e(base_url()); ?>member/change_pass" class=""method="POST">
    ...
    <div class="col-md-12">
        ...
        <div class="alert alert-success">
            <a class="close" data-dismiss="alert" href="#">×</a><?php echo e($success); ?>
    ...
    $(document).ready(function () {
        ...
        $("#form-edit-user").validate({rules: {
                passwordold: {
                    required: true,
                    remote: {
                        url: '<?php echo e(base_url()); ?>index/checkUserpass',
                        data: {
                            id: '<?php echo e($id_user); ?>'
                        },
                        type: "post"
                    }
                },
